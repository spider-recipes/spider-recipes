...
INSERT INTO Recipes (recipe_name, recipe_ingredients, recipe_steps, recipe_preparation_time_minutes, recipe_cooking_time_minutes, recipe_serving_size, recipe_image, time_created, user_id)
VALUES 
('Spider leg soup', '60g of Spider leg;3 cups of broth;Salt;Black pepper', 'To a pan on high heat, add spider legs and salt and pepper to taste.;Once almost cooked, add broth and allow to simmer.;Serve immediately.', 2, 10, 5, 'image_link1', GETDATE(), 1),
('Spider cake', 'Cake batter;Black and red food colouring', 'Add half of cake batter to baking dish and decorate with black and red food colouring to resemble a spider.;Add the other half of the batter and cook until set.;Allow to cool before slicing.', 10, 35, 3, 'image_link2', GETDATE(), 1),
